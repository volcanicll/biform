...
/** PC presentation: compact 16px box, hover background, optional description. */
export function PcCheckbox(props: CheckboxPresentationSharedProps) {
